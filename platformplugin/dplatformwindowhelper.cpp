        ...
        case QEvent::MouseButtonPress:
            if (event->type() == QEvent::MouseButtonPress
                    && (qApp->mouseButtons() != Qt::RightButton
                        || m_nativeWindow->window()->flags().testFlag(Qt::Popup)
                        || m_nativeWindow->window()->flags().testFlag(Qt::BypassWindowManagerHint)
                        || m_nativeWindow->window()->flags().testFlag(Qt::FramelessWindowHint))) {
                return false;
            }
        {
