...
- Add cursor size listener and optimize cursor theme handling
...
- 修复Qt 的 XCB 后端 GetProperty 有大量的 "BadAtom" 错误
...
- Improve vtable ownership verification in hasVtable
